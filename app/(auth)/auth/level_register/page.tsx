...
import ComponentsAuthLevelRegisterForm from '@/components/auth/level_regiter';
import Login from '@/components/auth/login';

const BoxedLevelClassSignUp = () => {
                        ...
                        <div className="mx-auto w-full max-w-[640px] ">
                            <div className="py-10">
                                <h1 className="text-xl font-extrabold uppercase !leading-snug text-primary md:text-xl lg:text-xl" style={{ color: '#493f8f' }}>
                                    Registration - Level Class 2026
                                </h1>
                                <p className="text-base font-bold leading-normal text-white-dark text-sm md:text-md lg:text-md">A Value Education Initiative Based on Student Class Level</p>
                            </div>

                            <ComponentsAuthLevelRegisterForm setLoader={setLoader} />
...
export default BoxedLevelClassSignUp;
