    ...
    return (
        <>
            ...
            <div className="relative flex min-h-screen items-center justify-center bg-[url(/assets/images/auth/map.png)] bg-cover bg-center bg-no-repeat lg:px-6 md:px-4 py-10 dark:bg-[#060818] px-0 ">
                ...
                <div className="relative w-full max-w-[500px] rounded-md bg-[linear-gradient(45deg,#fff9f9_0%,rgba(255,255,255,0)_25%,rgba(255,255,255,0)_75%,_#fff9f9_100%)] p-2 dark:bg-[linear-gradient(52.22deg,#0E1726_0%,rgba(14,23,38,0)_18.66%,rgba(14,23,38,0)_51.04%,rgba(14,23,38,0)_80.07%,#0E1726_100%)] lg:mt-10 md:mt-8">
                    <div className="relative flex flex-col justify-center rounded-md bg-white px-6  backdrop-blur-lg dark:bg-black/50 lg:min-h-[500px]">
                        <div className="mx-auto w-full max-w-[400px] ">
                            <div className="py-10 text-center">
                                ...
                                <p className="text-base font-bold leading-normal text-white-dark text-sm md:text-md lg:text-md">Enter your credentials to access your account</p>
                            </div>
