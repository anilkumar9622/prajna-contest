            ...
            <div>
                ...
                <div className="">
                    <div className="mb-6 grid gap-6 xl:grid-cols-3">
                        <div className="panel h-full xl:col-span-2">
                            ...
                            <p className="text-lg dark:text-white-light/90">
                                Total Amount <span className="ml-2 text-primary">10,840</span>
                            </p>
                        ...
                        <div className="panel h-full">
                            <div className="mb-5 flex items-center">
                                <h5 className="text-lg font-semibold dark:text-white-light">Registraion By Mode</h5>
                            </div>
                            <div>
                                <div className="rounded-lg bg-white dark:bg-black">
                                    {isMounted ? (
                    ...
                    <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
                        ...
                        <div className="panel h-full w-full">
                            <div className="mb-5 flex items-center justify-between">
                                <h5 className="text-lg font-semibold dark:text-white-light">Top Product</h5>
                            </div>
                            <div className="table-responsive">
                                <table>
                                    <thead>
